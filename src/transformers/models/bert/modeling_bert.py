...
class BertModel(BertPreTrainedModel):
    ...
    def __init__(self, config, add_pooling_layer=True, num_classes=None, task=None):
        ...
        self.classification_layer = nn.Linear(2048, self.num_classes)
        self.task = task
    ...
    def forward(
        ...
        return v1v2  # few-shot任务
        # supervised-learning任务
        '''
            classification_logits = self.classification_layer(v1v2)
            return classification_logits
        '''
