...
class RobertaModel(RobertaPreTrainedModel):
    ...
    def __init__(self, config, add_pooling_layer=True, num_classes=None):
        ...
        self.classification_layer = nn.Linear(1536, num_classes)
    ...
    def forward(
        ...
        return classification_logits #supervised learning
        #return v1v2 #few-shot
