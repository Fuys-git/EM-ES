...
def train_and_fit(args):
    ...
    if args.model_no == 0:
        ...
        net = Model.from_pretrained(pretrained_model_name_or_path='./pretrained/roberta_large/', \
    ...
    model_name_list = ['bert-base-uncased', 'albert-base-v2', 'roberta-large', 'bert-large-uncased']
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        for i, data in enumerate(train_loader, 0):
            ...
            classification_logits = net(x, token_type_ids=token_type_ids, \
                                attention_mask=attention_mask, e1_e2_start=e1_e2_start)
            ...
            total_acc += evaluate_(classification_logits, labels)[0]
