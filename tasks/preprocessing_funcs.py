    ...
    def __getitem__(self, idx):
        ...
        for sample_idx, r in enumerate(sampled_relation):
            ...
            for sampled_idx in sampled_idxs:
                ...
                meta_train_input.append(torch.LongTensor(sampled_sent).squeeze())
                e1_e2_start.append(sampled_e1_e2_start)
                meta_train_labels.append(torch.LongTensor([sampled_idx]).squeeze())
